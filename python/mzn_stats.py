from data_generator import multi_generator as get_instances
...
def two_plots(x, y1, y2, xlabel, y1label, y2label):
    ...
    ax1.grid()
    fig.suptitle("Comparison of time and computed distance increasing instance complexity", weight = "bold", fontsize = FONTSIZE)
    color = 'tab:red'
